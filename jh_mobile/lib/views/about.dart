...
class _AboutState extends State<About> {
  ...
  final List<Developer> developers = [
    ...
    Developer(
      ...
      telefone: 'Celular: (16) 98888-8888',
      fotoUrl: 'assets/images/img_nicolas.jpg',
    ),
    Developer(
      nome: 'Pedro Martins',
      cargo: 'Desenvolvedor backend',
      email: 'pedrohenriquelopesmartins@gmail.com',
      telefone: 'Celular: (16) 97777-7777',
    ),
    Developer(
      nome: 'Vinicius Ramos',
      cargo: 'Desenvolvedor de embarcados',
      email: 'viniciusaugusto@gmail.com',
      telefone: 'Celular: (16) 96666-6666',
    ),
    Developer(
      nome: 'Vinicius Gaban',
      cargo: 'Desenvolvedor Mobile',
      email: 'viniciusgaban@gmail.com',
      telefone: 'Celular: (16) 95555-5555',
